    ...
    <div>
      <div className="absolute z-10 w-full">
        <nav className="bg-transparent">
          <div class="flex flex-wrap items-center justify-between mx-10 py-4">
            <a href="/" class="flex items-center">
              <div >
                <img src="../legend-cinema.png" alt="" className="w-[100px]" />
              </div>
            </a>
            <div class="flex  justify-center items-center md:order-2">
              <div className="mr-10">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 ml-4">
                  <li>
                    <a
                      href="#"
